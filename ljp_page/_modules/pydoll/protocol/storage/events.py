...
from ljp_page._modules.pydoll.protocol.network.types import RequestId, TimeSinceEpoch
from ljp_page._modules.pydoll.protocol.page.types import FrameId
from ljp_page._modules.pydoll.protocol.storage.types import (
...
from ljp_page._modules.pydoll.protocol.target.types import TargetID


class StorageEvent(str, Enum):
    """来自 Chrome DevTools 协议存储域的事件。

    此枚举包含与存储相关的事件的名称，这些事件可以是
    从 Chrome DevTools 协议收到。这些事件提供了信息
    关于各种浏览器存储机制（包括缓存存储）的更改，
    IndexedDB、兴趣组、共享存储和存储桶。"""
