...
from ljp_page._modules.pydoll.protocol.dom.types import BackendNodeId
from ljp_page._modules.pydoll.protocol.network.types import LoaderId, MonotonicTime
...
from ljp_page._modules.pydoll.protocol.runtime.types import StackTrace


class PageEvent(str, Enum):
    """来自 Chrome DevTools 协议的 Page 域的事件。

    此枚举包含与页面相关的事件的名称，这些事件可以是
    从 Chrome DevTools 协议收到。这些事件提供了信息
    关于页面生命周期、框架导航、JavaScript 对话框等
    页面相关的活动。"""
