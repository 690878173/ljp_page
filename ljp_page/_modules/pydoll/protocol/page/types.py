...
from ljp_page._modules.pydoll.protocol.network.types import LoaderId, ResourceType, TimeSinceEpoch
from ljp_page._modules.pydoll.protocol.runtime.types import ScriptId, UniqueDebuggerId
