...
from ljp_page._modules.pydoll.protocol.emulation.methods import (
    EmulationMethod,
    SetUserAgentOverrideParams,
)

if TYPE_CHECKING:
    from ljp_page._modules.pydoll.protocol.emulation.methods import SetUserAgentOverrideCommand
