...
from ljp_page._modules.pydoll.protocol.fetch.methods import (
...
from ljp_page._modules.pydoll.protocol.fetch.types import RequestPattern
...
if TYPE_CHECKING:
    ...
    from ljp_page._modules.pydoll.protocol.fetch.types import (
        AuthChallengeResponseType,
        HeaderEntry,
        RequestStage,
        ResourceType,
    )
    from ljp_page._modules.pydoll.protocol.network.types import ErrorReason, RequestMethod
