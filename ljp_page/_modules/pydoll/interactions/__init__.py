...
from ljp_page._core._lazy_import import mapped_module_exports

if TYPE_CHECKING:
    from ljp_page._modules.pydoll.constants import DEFAULT_TYPO_PROBABILITY as DEFAULT_TYPO_PROBABILITY
    from ljp_page._modules.pydoll.constants import TypoType as TypoType
