...
from ljp_page._core.config import TimeoutConfig, RetryConfig, SessionPoolConfig, ProxyConfig
...
class LjpConfig:
    ...
    pool: SessionPoolConfig = field(default_factory=SessionPoolConfig)
