...
from ljp_page._module.data_analysis.ml.multimodal.multimodal import (
    Multimodal, DataConfig, DataGen
)
from ljp_page._module.data_analysis.visualization.matplotlib import Plotter
Matplotlib = Plotter
...
def main():
    ...
    from ljp_page._module.data_analysis.ml.multimodal.multimodal import ModalityData
