...
#从可输入字符映射到（键、代码、键代码）。
#key: DOM KeyboardEvent.key 值
#代码：DOM KeyboardEvent.code（美国 QWERTY 上的物理键）
#键码：旧版 KeyboardEvent.keyCode / 虚拟键码
#
#小写和大写字母共享相同的代码/键码；只有“key”不同。
#移位符号变体（例如“1”中的“！”）使用基本键的代码/键码。
