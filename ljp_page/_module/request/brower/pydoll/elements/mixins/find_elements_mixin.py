...
from ljp_page._module.request.brower.pydoll import ConnectionHandler
...
if TYPE_CHECKING:
    ...
    from dom.methods import DescribeNodeResponse
...
def create_web_element(*args, **kwargs):
    ...
    以防止循环导入依赖。"""
    from ljp_page._module.request.brower.pydoll.elements.web_element import WebElement  #编号：PLC0415
