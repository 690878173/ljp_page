...
from ljp_page._module.request.brower.pydoll.browser.managers import (
...
from browser.types import DownloadBehavior
...
if TYPE_CHECKING:
    ...
    from base import Command, Response, T_CommandParams, T_CommandResponse
    from browser.methods import (
        GetVersionResponse,
        GetVersionResult,
        GetWindowForTargetResponse,
    )
    from browser.types import Bounds, PermissionType
    from fetch.events import RequestPausedEvent
    ...
    from storage.methods import GetCookiesResponse
