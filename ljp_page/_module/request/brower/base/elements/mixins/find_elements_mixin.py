...
from ljp_page._module.request.brower.base.constants import By, Scripts
from ljp_page._module.request.brower.base.elements.utils import SelectorParser
from ljp_page._module.request.brower.base.exceptions import ElementNotFound, WaitElementTimeout
...
if TYPE_CHECKING:
    ...
    from ljp_page._module.request.brower.base.interactions.iframe import IFrameContext
    from ljp_page._module.request.brower.base.protocol.base import Command, T_CommandParams, T_CommandResponse
    from ljp_page._module.request.brower.base.protocol.dom.methods import DescribeNodeResponse
    from ljp_page._module.request.brower.base.protocol.dom.types import Node
...
def create_web_element(*args, **kwargs):
    ...
    以防止循环导入依赖。"""
    from ljp_page._module.request.brower.base.elements.web_element import WebElement  #编号：PLC0415
