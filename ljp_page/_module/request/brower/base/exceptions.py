__all__ = ['EdgeException', 'ConnectionException', 'ConnectionFailed', 'ReconnectionFailed', 'WebSocketConnectionClosed', 'NetworkError', 'BrowserException', 'BrowserNotRunning', 'FailedToStartBrowser', 'UnsupportedOS', 'NoValidTabFound', 'InvalidConnectionPort', 'InvalidWebSocketAddress', 'MissingTargetOrWebSocket', 'ProtocolException', 'TopLevelTargetRequired', 'InvalidCommand', 'InvalidResponse', 'ResendCommandFailed', 'CommandExecutionTimeout', 'InvalidCallback', 'EventNotSupported', 'ElementException', 'ElementNotFound', 'ElementNotVisible', 'ElementNotInteractable', 'ClickIntercepted', 'ElementNotAFileInput', 'ShadowRootNotFound', 'TimeoutException', 'PageLoadTimeout', 'WaitElementTimeout', 'DownloadTimeout', 'NavigationError', 'ConfigurationException', 'InvalidOptionsObject', 'InvalidBrowserPath', 'ArgumentAlreadyExistsInOptions', 'ArgumentNotFoundInOptions', 'InvalidFileExtension', 'InvalidTabInitialization', 'MissingScreenshotPath', 'DialogException', 'NoDialogPresent', 'NotAnIFrame', 'InvalidIFrame', 'IFrameNotFound', 'NetworkEventsNotEnabled', 'RequestException', 'HTTPError', 'HarRecordingError', 'ScriptException', 'InvalidScriptWithElement', 'WrongPrefsDict', 'ElementPreconditionError']
...
class ConnectionException(EdgeException):
    """与浏览器连接相关的异常的基类。"""
...
class BrowserException(EdgeException):
    """与浏览器进程管理相关的异常的基类。"""
...
class ProtocolException(EdgeException):
    """与 CDP 协议通信相关的异常的基类。"""
...
class ElementException(EdgeException):
    """与元素交互相关的异常的基类。"""
...
class TimeoutException(EdgeException):
    """与超时相关的异常的基类。"""
...
class NavigationError(EdgeException):
...
class ConfigurationException(EdgeException):
    """与配置和选项相关的异常的基类。"""
...
class DialogException(EdgeException):
    """与浏览器对话框相关的异常的基类。"""
...
class NotAnIFrame(EdgeException):
    """当元素不是 iframe 时引发。"""

    message = 'The element is not an iframe'


class InvalidIFrame(EdgeException):
    """当 iframe 无效时引发。"""

    message = 'The iframe is not valid'


class IFrameNotFound(EdgeException):
    """未找到 iframe 时引发。"""

    message = 'The iframe was not found'


class NetworkEventsNotEnabled(EdgeException):
    """未启用网络事件时引发。"""

    message = 'Network events not enabled'


class RequestException(EdgeException):
    """与 HTTP 请求相关的异常的基类。"""
...
class ScriptException(EdgeException):
...
class WrongPrefsDict(EdgeException):
