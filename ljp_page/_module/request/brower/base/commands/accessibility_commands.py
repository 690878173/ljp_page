...
from ljp_page._module.request.brower.base.protocol.accessibility.methods import (
    AccessibilityMethod,
...
if TYPE_CHECKING:
    ...
    from ljp_page._module.request.brower.base.protocol.accessibility.types import AXNodeId
