...
from ljp_page._module.request.brower.base.protocol.storage.methods import (
...
if TYPE_CHECKING:
    from ljp_page._module.request.brower.base.protocol.network.types import CookieParam
    from ljp_page._module.request.brower.base.protocol.storage.methods import (
        ClearCookiesCommand,
    ...
    from ljp_page._module.request.brower.base.protocol.storage.types import StorageBucket
